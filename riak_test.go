...
func TestObjectsWithSiblings(t *testing.T) {
	...
	obj.Indexes["mymultiindex_bin"] = []string{"multiindex1a", "multiindex1b"}
	...
	obj.Indexes["mymultiindex_bin"] = []string{"multiindex2a", "multiindex2b"}
	err = obj.Store()
	assert.T(t, err == nil)
	...
	// Multiindexes
	assert.T(t, obj.Siblings[0].Indexes["mymultiindex_bin"][0] != obj.Siblings[1].Indexes["mymultiindex_bin"][0])
	assert.T(t, len(obj.Siblings[0].Indexes["mymultiindex_bin"]) == 2)
	assert.T(t, len(obj.Siblings[1].Indexes["mymultiindex_bin"]) == 2)
